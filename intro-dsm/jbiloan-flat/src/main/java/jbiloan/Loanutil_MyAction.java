 ...
 */
public abstract class Loanutil_MyAction extends AbstractAction {
     ...
     */
    public Loanutil_MyAction(final String pCaption, int pKeyStroke, String pIconName, String pToolTipText) {
     ...
     * @param pToolTipText a user help tool tip (short description).
     */
    public Loanutil_MyAction(final String pCaption, String pIconName, String pToolTipText) {
     ...
     * @param pIconName base name of the icon (path is added automatically)
     */
    public Loanutil_MyAction(final String pCaption, String pIconName) {
        super(pCaption, Loanutil_FrameUtils.createImageIcon(pIconName, null));
    }
