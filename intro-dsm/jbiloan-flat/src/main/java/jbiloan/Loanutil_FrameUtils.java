 ...
 * @author jimbert
 */
public abstract class Loanutil_FrameUtils {
    ...
    public static void serialize(final Component pParent, Serializable pObject) {
        ...
        try {
            String lFilename = Loanutil_FrameUtils.chooseFile(pParent, "loan", "JBILoan compatible file", false);
            if (lFilename != null) {
    ...
    public static Object deserialize(final Component pParent) {
        ...
        try {
            String lFilename = Loanutil_FrameUtils.chooseFile(pParent, "loan", "JBILoan compatible file", true);
            if (lFilename != null) {
     ...
     * @return the string value of this in .csv format
     */
    public static String toCsv(final Loanmain_LoanItem pItem) {
        final String lSep = ";";
