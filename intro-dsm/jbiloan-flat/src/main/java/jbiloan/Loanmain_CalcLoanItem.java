 ...
 */
public final class Loanmain_CalcLoanItem {

    /**
     * Utility class => private constructor
     */
    private Loanmain_CalcLoanItem() {
    }
     ...
     */
    public static Double computeNotaryFee(final Loanmain_LoanItem pItem) {
     ...
     */
    private static Double calcF(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Double calcTauxBis(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Double calcTauxEff(final Loanmain_LoanItem pItem) {
     ...
     */
    private static Double solveTaux(final Double pC, final Loanmain_LoanItem pItem) {
        final double lD = pItem.getDuree();
        final double lPuis = 1D + 1D / 12D / lD;
        class lFunc implements Loansolver_OneParamFuncItf<Double> {
        ...
        Loansolver_SolverItf<Double> lSolver = new Loansolver_Solver();
        try {
     ...
     */
    public static Double computeMensHorsAss(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Double computeMensAss(final Loanmain_LoanItem pItem) {
     ...
     * @return the amount (A)
     */
    public static Double computeAmount(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Double computeDuration(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Double computeRate(final Loanmain_LoanItem pItem) {
     ...
     */
    public static Loanmain_LoanItem diff(final Loanmain_LoanItem pItem1, final Loanmain_LoanItem pItem2) {
        Loanmain_LoanItem lItem = new Loanmain_LoanItem();
