 ...
 */
public final class Loanmain_LoanItem implements Cloneable, Serializable {
     ...
     */
    private transient List<Loanmain_ChangeListener> changeListeners = null;
    /**
     * List of components that are interested in item diff events
     */
    private transient List<Loanmain_DiffListener> diffListeners = null;
    /**
...
//Methods
     ...
     * Default constructor
     */
    public Loanmain_LoanItem() {
        changeListeners = new ArrayList<Loanmain_ChangeListener>();
    }
     ...
     */
    @Override
    public Loanmain_LoanItem clone() {
        Loanmain_LoanItem lClone = new Loanmain_LoanItem();
...
//Listeners
     ...
     */
    public void addChangeListener(final Loanmain_ChangeListener pListener) {
     ...
     */
    public void removeChangeListener(final Loanmain_ChangeListener pListener) {
        if (changeListeners.contains(pListener)) {
    ...
    public void fireItemChanged() {
        for (Loanmain_ChangeListener lListener : changeListeners) {
     ...
     * @param pListener the new listener
     */
    public void addDiffListener(final Loanmain_DiffListener pListener) {
        if (diffListeners == null) {
            //This happens after a deserialization
            diffListeners = new ArrayList<Loanmain_DiffListener>();
        }
     ...
     * @param pListener the listener to remove from the list
     */
    public void removeDiffListener(final Loanmain_DiffListener pListener) {
        if (diffListeners.contains(pListener)) {
     ...
     */
    public void fireItemDiffed(final Loanmain_LoanItem pItem1, final Loanmain_LoanItem pItem2) {
        for (Loanmain_DiffListener lListener : diffListeners) {
