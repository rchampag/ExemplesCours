 ...
 */
public class Loansolver_Solver implements Loansolver_SolverItf<Double> {
     ...
     */
    private Double bissect(final Loansolver_OneParamFuncItf<Double> pFunc, final Double pMin, final Double pMax, final Double pAcc) {
        final int lJMax = 40;
        int lJ;
    ...
    @Override
    public Double solve(Loansolver_OneParamFuncItf<Double> pF, Double pXMin, Double pXMax, Double pAcc) {
